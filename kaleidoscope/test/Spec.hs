...
jitTests = testGroup "JIT Tests" $ map (\(s, expectedValue, returnType) -> testCase s $ do testProgramJIT s expectedValue returnType) [
  ...
  , ("add_float_float", 2, ASTType.double)
  , ("add_float_int", 2, ASTType.double)
  , ("add_int_float", 2, ASTType.double)
  , ("add_int_int", 2, ASTType.i32)
  , ("div_float_int", 2.5, ASTType.double)
  , ("div_int_int", 2, ASTType.i32)
  , ("and_true_true", 1, ASTType.i1)
  , ("and_true_false", 0, ASTType.i1)
  , ("and_false_true", 0, ASTType.i1)
  , ("and_false_false", 0, ASTType.i1)
  , ("or_true_true", 1, ASTType.i1)
  , ("or_true_false", 1, ASTType.i1)
  , ("or_false_true", 1, ASTType.i1)
  , ("or_false_false", 0, ASTType.i1)
  , ("not_true", 0, ASTType.i1)
  , ("not_false", 1, ASTType.i1)
