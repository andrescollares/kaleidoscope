...
processLibrary source = do
  result <- process baseDefinitions "" (CLIParameters {inputFile = "", failOnErrors = False, optimizationLevel = 3, emitLLVM = False, emitAST = False, emitLlvmDefs = False, compile = False})
  case result of
