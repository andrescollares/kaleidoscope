...
if.else_0:                                        ; preds = %0
  %2 = sub i32 %x_0, 1
  %3 = call i32 @fib.17(i32 %2)
  %4 = sub i32 %x_0, 2
  %5 = call i32 @fib.17(i32 %4)
  %6 = add i32 %3, %5
  br label %if.else_exit_0
...
define i32 @main() {
  %1 = call i32 @fib.17(i32 36)
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmtStr, i32 0, i32 0), i32 %1)
  ret i32 0
}
