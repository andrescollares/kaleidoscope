...
; Function Attrs: nounwind readonly
define double @sum.31(%FloatList* %l_0) local_unnamed_addr #2 {
  %1 = ptrtoint %FloatList* %l_0 to i64
  %2 = trunc i64 %1 to i32
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %if.end_0, label %if.else_0
...
if.else_0:                                        ; preds = %0
  ...
  %6 = getelementptr %FloatList, %FloatList* %l_0, i64 0, i32 1
  %7 = load %FloatList*, %FloatList** %6, align 8
  %8 = tail call double @sum.31(%FloatList* %7)
  %9 = fadd double %5, %8
  ret double %9
...
define %FloatList* @one_to_n.32(double %n_0) local_unnamed_addr {
  %1 = fcmp ule double %n_0, 0.000000e+00
  br i1 %1, label %if.end_0, label %if.else_0

if.else_0:                                        ; preds = %0
  %2 = fadd double %n_0, -1.000000e+00
  %3 = tail call %FloatList* @one_to_n.32(double %2)
  %4 = tail call %FloatList* @_alloc_double_list_node()
  %5 = getelementptr %FloatList, %FloatList* %4, i64 0, i32 0
  store double %n_0, double* %5, align 8
  %6 = getelementptr %FloatList, %FloatList* %4, i64 0, i32 1
  store %FloatList* %3, %FloatList** %6, align 8
  ret %FloatList* %4
...
define i32 @main() local_unnamed_addr {
  %1 = tail call %FloatList* @one_to_n.32(double 1.000000e+04)
  %2 = tail call double @sum.31(%FloatList* %1)
